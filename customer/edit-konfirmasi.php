                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-konfirmasi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                            ...
                            <option value="Lainnya">Cash On Delivery (COD)</option>
						    <?php } ?>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="jumlah" type="text" id="jumlah" value="<?php echo $row['jumlah']; ?>" class="form-control" readonly="readonly"autocomplete="off"/>
